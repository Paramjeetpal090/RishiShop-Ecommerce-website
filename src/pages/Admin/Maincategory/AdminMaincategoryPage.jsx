    ...
    <div className="container-fluid my-3">
      <div className="row">
        ...
        <div className="col-lg-9">
          <h5 className='bg-secondary text-center p-2 text-light'>Manicategory <Link to="/admin/maincategory/create"><i className='bi bi-plus text-light fs-5 float-end'></i></Link></h5>
          <div className="table responsive">
            <table className='table table-bordered3' id='myTable'>
              <thead>
                <tr>
                  <th>Id</th>
                  <th>Name</th>
              ...
              <tbody>
                {
                  data.map((item) => {
                    return <tr key={item.id}>
                      ...
                      <td><Link to={`/admin/maincategory/update/${item.id}`} className='btn btn-secondary'><i className='bi bi-pencil' ></i></Link></td>
