    ...
    <div className="container-fluid py-5">
        <div className="container">
            <div className="text-center mx-auto mb-5" style={{maxWidth: "500px"}}>
                <h5 className="d-inline-block text-secondary text-uppercase border-bottom border-5">Medical Packages</h5>
               ...
               <SwiperSlide>
                 <div className="bg-light rounded text-center">
                    <div className="position-relative">
                        ...
                        <div className="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center"
                            ...
                            <h1 className="display-4 text-white mb-0">
                                <small className="align-top fw-normal"
                                    ...
                                    className="align-bottom fw-normal" style={{fontSize: "16px", lineHeight: "40px"}}>/
                                    Year</small>
                            </h1>
                        </div>
                    </div>
                    <div className="text-center py-5">
                        ...
                        <a href="#!" className="btn btn-secondary rounded-pill py-3 px-5 my-2">Apply Now</a>
                    </div>
                </div>
               </SwiperSlide>
              <SwiperSlide>
