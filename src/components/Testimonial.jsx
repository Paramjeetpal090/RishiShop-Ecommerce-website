     ...
     <div className="container-fluid py-5">
        <div className="container">
            <div className="text-center mx-auto mb-5" style={{maxWidth: "500px"}}>
                <h5 className="d-inline-block text-secondary text-uppercase border-bottom border-5">Testimonial</h5>
                       ...
                       <div className="testimonial-item text-center">
                            <div className="position-relative mb-5">
                                ...
                                <div className="position-absolute top-100 start-50 translate-middle d-flex align-items-center justify-content-center bg-white rounded-circle"
                                    ...
                                    <i className="fa fa-quote-left fa-2x text-secondary"></i>
                                </div>
                            </div>
                            ...
                            <h3>Patient Name</h3>
                            <h6 className="fw-normal text-secondary mb-3">Profession</h6>
                        </div>
                    </SwiperSlide>
                        <SwiperSlide>
                            <div className="testimonial-item text-center">
