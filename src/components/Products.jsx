    ...
    <div className="container-fluid py-5">
        <div className="container">
            <div className="text-center mx-auto mb-5" style={{maxWidth: "500px"}}>
                <h5 className="d-inline-block text-secondary text-uppercase border-bottom border-5">Blog Post</h5>
                ...
                <div className="col-xl-4 col-lg-6">
                    <div className="bg-light rounded overflow-hidden">
                        ...
                        <div className="d-flex justify-content-between border-top p-4">
                            ...
                            <div className="d-flex align-items-center">
                                <small className="ms-3"><i className="far fa-eye text-secondary me-1"></i>12345</small>
                                <small className="ms-3"><i className="far fa-comment text-secondary me-1"></i>123</small>
                            </div>
                        </div>
                    </div>
                </div>
